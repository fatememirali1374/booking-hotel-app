...
import { HiCalendar, HiLogin, HiLogout, HiMinus, HiPlus, HiSearch } from "react-icons/hi"
        ...
        <div>
            {isAuthenticated ?
                (<div> <span>{user.name}</span>
                    <HiLogout onClick={handleLogout} className="icon" /></div>) :
